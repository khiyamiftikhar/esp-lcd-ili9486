...
The default image is [Lenna](https://i.gzn.jp/img/2009/06/18/lenna/000.jpg) —

The `jpeg_decoder` component is used internally as a lightweight streaming helper —
the focus of this example is the ILI9486 panel setup, SPI wiring, and the
end-to-end pipeline from network to display.

---

## What It Demonstrates

- **ILI9486 over SPI** — panel init, landscape/portrait orientation, DMA-backed
  row-by-row rendering via `esp_lcd_panel_draw_bitmap`
...
|-----|---------|-------------|
| `CONFIG_JPEG_URL` | `https://i.gzn.jp/img/2009/06/18/lenna/000.jpg` | Full HTTPS URL of the JPEG to fetch |
